namespace SharedTrip.Common
{
    public static class GlobalConstants
    {
        ...
        public const string InvalidStartPoint = "Invalid start point!";

        public const string InvalidEndPoint = "Invalid end point!";

        public const string InvalidDescription = "Description is required with maximal {0} characters!";

        public const string InvalidSeatsCount = "Seats should be between {0} and {1}!";

        public const string InvalidDeparturetime = "Invalid departure time!";  
    }
}
