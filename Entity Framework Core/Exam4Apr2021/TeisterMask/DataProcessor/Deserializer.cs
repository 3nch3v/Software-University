namespace TeisterMask.DataProcessor
{
    ...
    public class Deserializer
    {
        ...
        {
            XmlSerializer serializer = new XmlSerializer(typeof(ProjectImportModel[]), new XmlRootAttribute("Projects"));
            TextReader reader = new StringReader(xmlString);
            var projectsDtos = (IEnumerable<ProjectImportModel>)serializer.Deserialize(reader);
        ...
        {
            var employeesDtos = JsonConvert.DeserializeObject<ICollection<EmplImport>>(jsonString);
